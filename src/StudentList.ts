 ...
 */
studentList.push(new Student({ Id: "1Eda3", Name: "John Smith", Grade: "1", ProfilePicture: "" }));
studentList.push(new Student({ Id: "130Ek", Name: "Katie Frank", Grade: "2", ProfilePicture: "" }));
studentList.push(new Student({ Id: "93kam", Name: "Steven Smith", Grade: "1", ProfilePicture: "" }));
studentList.push(new Student({ Id: "ka93K", Name: "Jane Smith", Grade: "1", ProfilePicture: "" }));
studentList.push(new Student({ Id: "56Ifj", Name: "Jack Sparrow", Grade: "1", ProfilePicture: "" }));